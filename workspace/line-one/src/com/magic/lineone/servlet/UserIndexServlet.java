...
import com.magic.lineone.db.DbUserIndex;

public class UserIndexServlet extends AbstractServlet {
    ...
    private final DbUserIndex dbUserIndex      = DbUserIndex.getInstance (WebServiceConfiguration.getInstance ()
                                                       .getJdbcurl ());
    ...
    public void dealWithCookie (HttpServletRequest request, HttpServletResponse response, String sid, String username,
        ...
        List <Map <String, String>> userList = dbUserIndex.getUsers (key, "any", pagenum, pagesize);
