...
public class MyCircleListServlet extends AbstractServlet {
    ...
    public void dealWithCookie (HttpServletRequest request, HttpServletResponse response, String sid, String username,
        ...
        List <Map <String, String>> circleList = dbCircle.getCircle (userid, pagenum, pagesize);
        ...
        try {
            for (Map <String, String> map : circleList) {
                ...
                circle.put ("ispublic", map.get ("ispublic"));
                array.put (circle);
            }
