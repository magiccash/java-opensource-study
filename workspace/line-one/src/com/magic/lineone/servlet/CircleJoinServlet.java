...
public class CircleJoinServlet extends AbstractServlet {
    ...
    public void dealWithCookie (HttpServletRequest request, HttpServletResponse response, String sid, String username,
        ...
        try {
            ...
            if (!dbCircle.hasjoined (circleID, userid)) {
                if (dbCircle.join (circleID, userid) && dbCircle.upateTotalNumA (circleID)) {
