...
public class CommentDeleteServlet extends AbstractServlet {
        ...
        try {
            ...
            if (dbComment.delete (commentID)) {
                ...
                Logger.getLogger (this.getClass ()).error (
                        "delete comment error! userid:" + userid + "commentID:" + commentID);
                failureReason = "delete comment error!";
            }
